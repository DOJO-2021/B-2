 ...
 */
@WebServlet("/FaceCollectServlet2")
public class FaceCollectServlet2 extends HttpServlet {
...
//    		int user_id= (int)session.getAttribute("user_id");
    		...
    		//アンケート名を取得
    				QuestionNameDao qDao = new QuestionNameDao();
    				List<Questionare> q_nameList = qDao.NewQ_Data();
...
//    						// メンタルの集計結果
    ...
    //
    		...
    		// 講師用顔文字閲覧ページにフォワードする
    		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/faceview2.jsp");
