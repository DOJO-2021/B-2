...
//          User test_user = new User(0,user_l_name, user_f_name, user_password, user_questions, user_answer, user_word, 1();
//            if (bDao.insert(new User(0,user_l_name, user_f_name, user_password, user_questions, user_answer, user_word, 1))) {   // 登録成功
